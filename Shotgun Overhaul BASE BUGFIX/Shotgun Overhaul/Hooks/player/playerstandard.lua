local old_init = PlayerStandard.init
...
function PlayerStandard:update(t, dt)
	self.RUN_AND_RELOAD = managers.player:has_category_upgrade("player", "run_and_reload") or self._equipped_unit and self._equipped_unit:base():is_category("shotgun") and managers.player:has_category_upgrade("shotgun", "sprint_reload")
				...
				elseif self._running and not self._equipped_unit:base():run_and_shoot_allowed() then
					...
					if not self._shooting then
						if weap_base:start_shooting_allowed() then
							local start = fire_mode == "single" and input.btn_primary_attack_state and self._attack_released
					...
					if fire_mode == "single" then
						if input.btn_primary_attack_state and start_shooting then
